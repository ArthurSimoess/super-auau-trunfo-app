...
import happy from '../images/happydog.png';
import sad from '../images/saddog.png';
  ...
  return (
    <main className="flex flex-col gap-2">
      <div className="flex flex-col items-center">
        <img src={win ? happy : sad} alt="Dog" width="70px" />
      ...
      <section className="flex flex-col items-center relative h-auto w-72 border-solid border-8 border-black bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 shadow-white shadow-md sm:w-72 md:w-72 lg:w-72 text-white">
