      ...
      <div className="bg-white shadow-2xl max-w-md m-auto flex flex-col items-center rounded-xl p-10 gap-6 pb-2">
        ...
        <ul className="list-disc">
          <li className="mb-3 text-justify">
            O número de cartas do baralho precisa ser necessariamente par,
            caso contrário o botão para salvar o baralho não será habilitado na tela.
          </li>
          <li className="mb-3 text-justify">
            A imagem da carta deverá ser necessariamente o link url de alguma
            imagem que esteja disponível na internet.
          </li>
          <li className="mb-3 text-justify">
